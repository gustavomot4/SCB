...
- [x] **[M6.5] C2 Dixon-Coles — PASSA na E0 (empate +0,00039 IC>0, ρ=−0,05), rejeitado no BRA (ρ instável entre eras) — D-23** — `scb/dixon_coles.py` + 3 testes (62); Q-05 aberta (2º gate do re-blend)
- [x] **[M6.6] C5 regressão de temporada — PASSA NO BRA (1º ✅ da liga-produto: Δ1X2 +0,00216 IC>0, ρ=0,30), rejeitada na E0 (D-24)** — `scb/season_rho.py`; **Q-06 aberta (adoção recomendada)**
- [ ] **[M6.7] ▶ ADOÇÕES (decisão Gustavo): Q-06 (ρ no BRA — recomendada) · Q-04 (mando rolling E0) · Q-05 (DC E0, 2º gate)** — wiring por liga + bump `scb-v0.2` + rebuild + re-run M4 + registrar previsões 2026 antes/depois
- [ ] **[M6] Fila restante: C4 viagem · C6 H por clube · banda/σ_dr (D-17)** — um por vez, cada um com portão
