...
## Estado atual
Plano e contrato **congelados** (D-11). M1 e **M2 FECHADAS** (2026-07-15; portão oficial na máquina do Gustavo: pytest 14 passed; ingest BRA 5.496 / E0 12.704; `dados/scb.sqlite` pronto com odds open/close e fallback D-16 — BRA-2026 com fechamento 177/177). Fatos da liga [medidos]: BRA empate 26,8% / gols 2,40; E0 regime distinto → curvas por liga (D-07). **M4 FECHADA (oficial, dígito a dígito) — `baseline-scb-v0.1` CONGELADO (D-17)**: BRA 0,6146 / E0 0,5899 batem uniforme+taxa-base+Elo-puro com IC>0; mercado ~2pp à frente (teto). **M5 pronta**: `simulate_league` (BRA 2026: Palmeiras 78,8% título; D-18), `predict_match` (D-34), `registrar` imutável + runbook [[Operacao BRA 2026]]. Testes: 50. **Pendências:** run oficial M5 (`pytest` → 50; `simulate_league --season 2026`), **Q-03 (Gustavo: ordem CBF)** e **começar a registrar a próxima rodada do BRA 2026**. **Próximo: M6 — calibração (H/K/T_base/banda) + fila do portão C1–C6** com os insumos já medidos; monitor de drift entra quando houver registro acumulado.
