...
## Estado atual
Plano e contrato **congelados** (D-11). M1 e **M2 FECHADAS** (2026-07-15; portão oficial na máquina do Gustavo: pytest 14 passed; ingest BRA 5.496 / E0 12.704; `dados/scb.sqlite` pronto com odds open/close e fallback D-16 — BRA-2026 com fechamento 177/177). Fatos da liga [medidos]: BRA empate 26,8% / gols 2,40; E0 regime distinto → curvas por liga (D-07). Baseline `scb-v0.1` (D-17: BRA 0,6146 / E0 0,5899). **Fila do portão: 3 testados** — M6.1 estático (D-19 ✗) · M6.2 drift gols/C3 (D-20 ✗) · **M6.3 mando rolling: PASSA na E0 (D-21 — 1º ✅ do projeto: 1X2 +0,0018 IC>0, δ −36,8 Elo), rejeitado no BRA**. **Q-04 aberta (Gustavo): adotar na E0?** (wiring + bump v0.2 + re-run M4; BRA não muda). Q-03 fechada. Testes: 56. **Operação = prioridade nº 1:** registrar toda rodada do BRA 2026 ([[Operacao BRA 2026]]). **MODELO ATUAL: `scb-v0.2-rho-bra` (D-25 — 1ª adoção: ρ=0,30 na virada de temporada do BRA).** M4 v0.2: **BRA 0,6131** (era 0,6146; ECE 0,0224; gap mercado −0,0180) · E0 0,5899 (intacta — wiring por liga isolado). Sim 2026: Palmeiras 79,6% título. Fila M6 (7 rodadas): BRA 1 adoção/5 rejeições; E0 2 aprovações pendentes (**Q-04 mando rolling · Q-05 DC c/ 2º gate**). Testes: 63. **Pendência: rebuild oficial na máquina do Gustavo** (pytest → elo → features → draw_curve → predictor → harness: BRA 0,6131) e o registro das rodadas de 2026 ([[Operacao BRA 2026]]). Fila restante: Q-04/Q-05 · C4 viagem · C6 H por clube · banda/σ_dr. Depois M7 (web + empacotamento).
