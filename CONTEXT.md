...
## Estado atual
Plano e contrato **congelados** (D-11). M1 e **M2 FECHADAS** (2026-07-15; portão oficial na máquina do Gustavo: pytest 14 passed; ingest BRA 5.496 / E0 12.704; `dados/scb.sqlite` pronto com odds open/close e fallback D-16 — BRA-2026 com fechamento 177/177). Fatos da liga [medidos]: BRA empate 26,8% / gols 2,40; E0 regime distinto → curvas por liga (D-07). Baseline `scb-v0.1` (D-17: BRA 0,6146 / E0 0,5899) segue **o melhor modelo conhecido** — a fila do portão já rejeitou com números: M6.1 grid estático H/T_base (D-19, 2 ligas) e M6.2 drift PIT de gols/C3 (D-20, 2 ligas, kill-switch ok). **Q-03 FECHADA** (ordem CBF 2026 = implementada; D-18). Testes: 53. **Operação é a prioridade nº 1:** registrar toda rodada do BRA 2026 antes do kickoff ([[Operacao BRA 2026]]) — perecível. **Fila da M6** (uma por sessão, com portão): M6.3 mando rolling PIT (ângulo novo da D-19) · C1 descanso · C2 Dixon-Coles · C4 viagem · C5 regressão de temporada · C6 H por clube · banda/σ_dr (sub-cobre extremos). Depois M7 (web + empacotamento, prompts/05).
